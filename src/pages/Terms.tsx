    ...
    <main className="flex-grow">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Data Usage</h2>
              <p className="text-lg text-gray-600">
            ...
            <p className="text-lg text-gray-600">
              If you have any questions about these terms, please contact us at <strong><a href="#" className="text-blue-600 hover:text-blue-800">abby-terms@weareda.com</a></strong>
            </p>
          </div>
        </div>
    </main>
